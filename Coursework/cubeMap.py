...
class CubeMap(Texture):
    ...
    def __init__(self, name=None, files=None, wrap=GL_CLAMP_TO_EDGE, sample=GL_LINEAR, format=GL_RGBA, type=GL_UNSIGNED_BYTE):
        ...
        self.files = {
            GL_TEXTURE_CUBE_MAP_NEGATIVE_X: 'skyrender0004.bmp',
            GL_TEXTURE_CUBE_MAP_POSITIVE_Z: 'skyrender0005.bmp',
            GL_TEXTURE_CUBE_MAP_POSITIVE_X: 'skyrender0001.bmp',
            GL_TEXTURE_CUBE_MAP_NEGATIVE_Z: 'skyrender0002.bmp',
            GL_TEXTURE_CUBE_MAP_POSITIVE_Y: 'skyrender0006.bmp',
            GL_TEXTURE_CUBE_MAP_NEGATIVE_Y: 'skyrender0003.bmp',
        }
